...
mod tests {
    ...
    //     let res = encrypt::<u8, 26>(key, pt);
    //     assert_eq!(ct, res.unwrap());
    // }

    // #[test]
    // fn encrypt_kernel_8_12_4() {
    //     let key = vec![0x00, 0x01, 0x02, 0x03];
    //     let pt = [0x00, 0x01];
    //     let ct = [0x21, 0x2A];
    //     let res = encrypt_kernel::<u8, 26>(key, pt);
    //     assert!(&ct[..] == &res[..]);
    // }
    ...
    //     let res = encrypt::<u16, 34>(key, pt);
    //     assert_eq!(ct, res.unwrap());
    // }

    // #[test]
    // fn encrypt_kernel_16_16_8() {
    //     let key = vec![0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07];
    //     let pt = [0x0100, 0x0302];
    //     let ct = [0xA823, 0x2ED7];
    //     let res = encrypt_kernel::<u16, 34>(key, pt);
    //     assert!(&ct[..] == &res[..]);
    // }
    ...
    //     let res = encrypt::<u32, 42>(key, pt);
    //     assert_eq!(ct, res.unwrap());
    // }

    // #[test]
    // fn encrypt_kernel_32_20_16() {
    //     let key = vec![
    //         0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D,
    //         0x0E, 0x0F,
    //     ];
    ...
    //     let res = encrypt_kernel::<u32, 42>(key, pt);
    //     assert!(&ct[..] == &res[..]);
    // }
    ...
    //     let pt = vec![0x00, 0x01];
    //     let ct = vec![0x21, 0x2A];
    //     let res = decrypt::<u8, 26>(key, ct);
    //     assert_eq!(pt, res.unwrap());
    // }

    // #[test]
    // fn decrypt_kernel_8_12_4() {
    //     let key = vec![0x00, 0x01, 0x02, 0x03];
    //     let pt = [0x00, 0x01];
    //     let ct = [0x21, 0x2A];
    //     let res = decrypt_kernel::<u8, 26>(key, ct);
    //     assert!(&pt[..] == &res[..]);
    // }
    ...
    //     let pt = vec![0x00, 0x01, 0x02, 0x03];
    //     let ct = vec![0x23, 0xA8, 0xD7, 0x2E];
    //     let res = decrypt::<u16, 34>(key, ct);
    //     assert_eq!(pt, res.unwrap());
    // }

    // #[test]
    // fn decrypt_kernel_16_16_8() {
    //     let key = vec![0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07];
    //     let pt = [0x0100, 0x0302];
    //     let ct = [0xA823, 0x2ED7];
    //     let res = decrypt_kernel::<u16, 34>(key, ct);
    //     assert!(&pt[..] == &res[..]);
    // }
    ...
    //     let pt = vec![0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07];
    //     let ct = vec![0x2A, 0x0E, 0xDC, 0x0E, 0x94, 0x31, 0xFF, 0x73];
    //     let res = decrypt::<u32, 42>(key, ct);
    //     assert_eq!(pt, res.unwrap());
    // }

    // #[test]
    // fn decrypt_kernel_32_20_16() {
    //     let key = vec![
    //         0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D,
    //         0x0E, 0x0F,
    //     ];
    //     let pt = [0x03020100, 0x07060504];
    //     let ct = [0x0EDC0E2A, 0x73FF3194];
    //     let res = decrypt_kernel::<u32, 42>(key, ct);
    //     assert!(&pt[..] == &res[..]);
    // }
    ...
    //         0x78, 0xDA,
    //     ];
    //     let res = decrypt::<u64, 50>(key, ct);
    //     assert_eq!(pt, res.unwrap());
    // }

    // #[test]
    // fn decrypt_kernel_64_24_24() {
    //     let key = vec![
    //         0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D,
    //         0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
    //     ];
    ...
    //     let res = decrypt_kernel::<u64, 50>(key, ct);
    //     assert!(&pt[..] == &res[..]);
    // }

    // #[test]
    // fn decrypt_128_28_32() {
    //     let key = vec![
    //         0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D,
    //         0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B,
    //         0x1C, 0x1D, 0x1E, 0x1F,
    ...
    //         0xE1, 0x80, 0xB4, 0x40,
    //     ];
    //     let res = decrypt::<u128, 58>(key, ct);
    //     assert_eq!(pt, res.unwrap());
    // }

    // #[test]
    // fn decrypt_kernel_128_28_32() {
    //     let key = vec![
    //         0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D,
    //         0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B,
    //         0x1C, 0x1D, 0x1E, 0x1F,
    ...
    //         0x40B480E17F4B91FE682D75CDA7C78E06,
    //     ];
    //     let res = decrypt_kernel::<u128, 58>(key, ct);
    //     assert!(&pt[..] == &res[..]);
    // }
}
